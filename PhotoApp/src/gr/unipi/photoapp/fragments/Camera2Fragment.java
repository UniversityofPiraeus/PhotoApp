...
import gr.unipi.photoapp.camera2.Camera2Constraints;
...
import gr.unipi.photoapp.directory.PhotoSaver;
 ...
 * must implement the {@link Camera2Fragment.OnFragmentInteractionListener}
 * interface to handle interaction events. Use the
 * {@link Camera2Fragment#newInstance} factory method to create an instance of
 * this fragment.
 * 
 * Integrate with sensors Gyroscope, (Accelerometer, Magnetometer) Compass, 
 * also with Gps Service to provide extra info about the captured image
 * 
 */
	...
	implements View.OnClickListener, OnTouchListener, SensorEventListener 
{
     ...
     */
    private int mState = Camera2Constraints.STATE_PREVIEW;
    /**
    ...
    /**
     * flag to control capture because camera captures 2 times
     */
    private boolean clickCapture = false;
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
        	...
        	if(clickCapture)
        	{
	        	...
	        	String fileName = "IMAGE_"+timestamp.getTime()+MEDIA_TYPE_IMAGE;
	        	mFile = new File(PhotoDirectory.getInstance().getImageDirectory(), fileName);	        
	        	mBackgroundHandler.post(new PhotoSaver(image, mFile));
	        	
//	        	mFile = new File(PhotoDirectory.getInstance().getImageThubnailsDirectory(), fileName);	
//	        	mBackgroundHandler.post(new PhotoSaver(image, mFile, true));
//	        	
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        private void process(CaptureResult result) {
            switch (mState) {
                case Camera2Constraints.STATE_PREVIEW: {
                    // We have nothing to do when the camera preview is working normally.
                    break;
                }
                case Camera2Constraints.STATE_WAITING_LOCK: {
                    ...
                    if (CaptureResult.CONTROL_AF_STATE_FOCUSED_LOCKED == afState ||
                        ...
                        if (aeState == null ||
                            ...
                            mState = Camera2Constraints.STATE_WAITING_NON_PRECAPTURE;
                            captureStillPicture();
                        } else {
                ...
                case Camera2Constraints.STATE_WAITING_PRECAPTURE: {
                    // CONTROL_AE_STATE can be null on some devices
                    Integer aeState = result.get(CaptureResult.CONTROL_AE_STATE);
                    if (aeState == null ||
                ...
                case Camera2Constraints.STATE_WAITING_NON_PRECAPTURE: {
                    // CONTROL_AE_STATE can be null on some devices
                    Integer aeState = result.get(CaptureResult.CONTROL_AE_STATE);
                    if (aeState == null || aeState != CaptureResult.CONTROL_AE_STATE_PRECAPTURE) {
                        mState = Camera2Constraints.STATE_PICTURE_TAKEN;
                        captureStillPicture();
                    }
                    break;
                }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        gpsService = new GPSService(getActivity().getBaseContext());
        initSensors();
    }
    ...
    private void lockFocus() {
        try {
            ...
            mState = Camera2Constraints.STATE_WAITING_LOCK;
    ...
    private void runPrecaptureSequence() {
        try {
            ...
            mState = Camera2Constraints.STATE_WAITING_PRECAPTURE;
    ...
    private void unlockFocus() {
        try {
            ...
            mState = Camera2Constraints.STATE_PREVIEW;
